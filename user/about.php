...
$viewCount = number_format($dataChan['totalViews']);
$description = $dataChan['descriptionHtml'];
...
<meta name="keywords" content="<?php echo $words; ?>">    <link rel="image_src" href="<?php echo $authorThumb; ?>">
    ...
    <meta property="al:ios:app_name" content="YouTube">
      <meta property="al:ios:url" content="vnd.youtube://channel/<?php echo $authorId; ?>">
    ...
    <meta name="twitter:app:id:ipad" content="544007664">
      <meta name="twitter:app:url:iphone" content="vnd.youtube://channel/<?php echo $authorId; ?>">
      <meta name="twitter:app:url:ipad" content="vnd.youtube://channel/<?php echo $authorId; ?>">
  ...
  <div id="watch-container" itemid="" itemscope itemtype="http://schema.org/YoutubeChannelV2">
    ...
    <span itemprop="thumbnail" itemscope itemtype="http://schema.org/ImageObject">
      ...
      <div class="cmt_iframe_holder" data-href="http://www.youtube.com/channel/<?php echo $authorId; ?>/about" data-viewtype="FILTERED" style="display: none;"></div>
...
<ul class="appbar-nav-menu"><li>    <a href="/channel/<?php echo $authorId; ?>/featured" class="yt-uix-button   spf-link yt-uix-sessionlink yt-uix-button-epic-nav-item yt-uix-button-size-default" data-sessionlink="ei=rvLWU-XTMZGW-QPz1YCQDw&amp;ved=CDQQwy0oAA"><span class="yt-uix-button-content"><?php echo $author; ?> </span></a>
</li><li>    <a href="/channel/<?php echo $authorId; ?>/videos" class="yt-uix-button   spf-link yt-uix-sessionlink yt-uix-button-epic-nav-item yt-uix-button-size-default" data-sessionlink="ei=rvLWU-XTMZGW-QPz1YCQDw&amp;ved=CDUQwy0oAQ"><span class="yt-uix-button-content">Videos </span></a>
</li><li>    <a href="/channel/<?php echo $authorId; ?>/playlists" class="yt-uix-button   spf-link yt-uix-sessionlink yt-uix-button-epic-nav-item yt-uix-button-size-default" data-sessionlink="ei=rvLWU-XTMZGW-QPz1YCQDw&amp;ved=CDYQwy0oAg"><span class="yt-uix-button-content">Playlists </span></a>
</li><li>    <a href="/channel/<?php echo $authorId; ?>/channels" class="yt-uix-button   spf-link yt-uix-sessionlink yt-uix-button-epic-nav-item yt-uix-button-size-default" data-sessionlink="ei=rvLWU-XTMZGW-QPz1YCQDw&amp;ved=CDcQwy0oAw"><span class="yt-uix-button-content">Channels </span></a>
</li><li>    <a href="/channel/<?php echo $authorId; ?>/discussion" class="yt-uix-button   spf-link yt-uix-sessionlink yt-uix-button-epic-nav-item yt-uix-button-size-default" data-sessionlink="ei=rvLWU-XTMZGW-QPz1YCQDw&amp;ved=CDgQwy0oBA"><span class="yt-uix-button-content">Discussion </span></a>
  ...
  >
    ...
    <div id="guide-builder-promo-buttons" class="signed-out clearfix">
      <a href="https://accounts.google.com/ServiceLogin?service=youtube&amp;continue=https%3A%2F%2Fwww.youtube.com%2Fsignin%3Ffeature%3Dsign_in_promo%26hl%3Den%26action_handle_signin%3Dtrue%26next%3D%252Fchannel%252F<?php echo $authorId; ?>%252Fabout%26app%3Ddesktop&amp;hl=en&amp;uilel=3&amp;passive=true" class="yt-uix-button   yt-uix-sessionlink yt-uix-button-primary yt-uix-button-size-default" data-sessionlink="ei=rvLWU-XTMZGW-QPz1YCQDw"><span class="yt-uix-button-content">Sign In </span></a>
    </div>
  </li>
...
Loading...
  ...
  <div class="yt-dialog-working-bubble">
    ...
    <h1 class="branded-page-header-title">
      <span class="qualified-channel-title ellipsized has-badge"><span class="qualified-channel-title-wrapper"><span dir="ltr" class="qualified-channel-title-text" ><a dir="ltr" href="/channel/<?php echo $authorId; ?>" class="spf-link branded-page-header-title-link yt-uix-sessionlink" title="<?php echo $author; ?>" data-sessionlink="ei=rvLWU-XTMZGW-QPz1YCQDw"      ><?php echo $author; ?></a></span></span><?php echo $verifiedHtml; ?></span>
    </h1>
  </div>
    ...
    <ul id="channel-navigation-menu" class="clearfix">
        <li>
          <a href="/channel/<?php echo $authorId; ?>/featured" class="yt-uix-button  spf-link  yt-uix-sessionlink yt-uix-button-epic-nav-item yt-uix-button-size-default" data-sessionlink="ei=rvLWU-XTMZGW-QPz1YCQDw"><span class="yt-uix-button-content">Home </span></a>
        </li>
        <li>
          <a href="/channel/<?php echo $authorId; ?>/videos" class="yt-uix-button  spf-link  yt-uix-sessionlink yt-uix-button-epic-nav-item yt-uix-button-size-default" data-sessionlink="ei=rvLWU-XTMZGW-QPz1YCQDw"><span class="yt-uix-button-content">Videos </span></a>
        </li>
        <li>
          <a href="/channel/<?php echo $authorId; ?>/playlists" class="yt-uix-button  spf-link  yt-uix-sessionlink yt-uix-button-epic-nav-item yt-uix-button-size-default" data-sessionlink="ei=rvLWU-XTMZGW-QPz1YCQDw"><span class="yt-uix-button-content">Playlists </span></a>
        </li>
        <li>
          <a href="/channel/<?php echo $authorId; ?>/channels" class="yt-uix-button  spf-link  yt-uix-sessionlink yt-uix-button-epic-nav-item yt-uix-button-size-default" data-sessionlink="ei=rvLWU-XTMZGW-QPz1YCQDw"><span class="yt-uix-button-content">Channels </span></a>
        </li>
        <li>
          <a href="/channel/<?php echo $authorId; ?>/discussion" class="yt-uix-button  spf-link  yt-uix-sessionlink yt-uix-button-epic-nav-item yt-uix-button-size-default" data-sessionlink="ei=rvLWU-XTMZGW-QPz1YCQDw"><span class="yt-uix-button-content">Discussion </span></a>
        </li>
        <li>
...
<p><?php echo $description; ?></p>
      ...
      <ul class="about-stats">
        <li class="about-stat ">
      <b><?php echo $subCount; ?></b> subscribers
    </li>
...
<div class="hid">    <div id="shared-addto-watch-later-login" class="hid">
      <a href="https://accounts.google.com/ServiceLogin?service=youtube&continue=https%3A%2F%2Fwww.youtube.com%2Fsignin%3Ffeature%3Dplaylist%26hl%3Den%26action_handle_signin%3Dtrue%26next%3D%252Fchannel%252F<?php echo $authorId; ?>%252Fabout%26app%3Ddesktop&hl=en&uilel=3&passive=true" class="sign-in-link">Sign in</a> to add this to Watch Later
