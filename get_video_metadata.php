...
//Properly escape specific characters
$descriptionBland = str_replace("\n", "\\n", $dataVid['description']);
$descriptionBland = str_replace('"', '\"', $descriptionBland);
